...
import 'package:topprix/features/home/retailer_home/stores/screen/store_management_page.dart';
...
class UserStoresPageThree extends StatefulWidget {
  const UserStoresPageThree({
    super.key,
  });

  @override
  State<UserStoresPageThree> createState() => _UserStoresPageThreeState();
}

class _UserStoresPageThreeState extends State<UserStoresPageThree> {
  List<Store> stores = [];
  bool isLoading = true;
  String? errorMessage;
  ...
  void _navigateToStoreDetails(Store store) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => StoreManagementPage(store: store),
      ),
    );
  }
}

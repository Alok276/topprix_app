...
import 'package:topprix/features/home/retailer_home/coupons/screen/coupon_management_page.dart';
...
class UserStoresPageFive extends StatefulWidget {
  const UserStoresPageFive({
    super.key,
  });

  @override
  State<UserStoresPageFive> createState() => _UserStoresPageFiveState();
}

class _UserStoresPageFiveState extends State<UserStoresPageFive> {
  List<Store> stores = [];
  bool isLoading = true;
  String? errorMessage;
  ...
  void _navigateToStoreDetails(Store store) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CouponManagementPage(store: store),
      ),
    );
  }
}

...
import 'package:topprix/features/home/retailer_home/coupons/screen/store_coupon_page.dart';
...
class UserStoresPageTwo extends StatefulWidget {
  const UserStoresPageTwo({
    super.key,
  });

  @override
  State<UserStoresPageTwo> createState() => _UserStoresPageTwoState();
}

class _UserStoresPageTwoState extends State<UserStoresPageTwo> {
  List<Store> stores = [];
  bool isLoading = true;
  String? errorMessage;
  ...
  void _navigateToStoreDetails(Store store) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => StoreCouponsPage(store: store),
      ),
    );
  }
}

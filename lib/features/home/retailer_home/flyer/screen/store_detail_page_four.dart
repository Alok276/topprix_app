...
import 'package:topprix/features/home/retailer_home/flyer/screen/flyer_management_page.dart';
...
class UserStoresPageFour extends StatefulWidget {
  const UserStoresPageFour({
    super.key,
  });

  @override
  State<UserStoresPageFour> createState() => _UserStoresPageFourState();
}

class _UserStoresPageFourState extends State<UserStoresPageFour> {
  List<Store> stores = [];
  bool isLoading = true;
  String? errorMessage;
  ...
  void _navigateToStoreDetails(Store store) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => FlyerManagementPage(store: store),
      ),
    );
  }
}
